                        ...
                        <ul class="nav-right">
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <span>{{session('instrutor')->nome}}</span>
                                    <i class="ti-angle-down"></i>
                                </a>
                                <ul class="show-notification profile-notification">
                                    <li class="waves-effect waves-light">
                                        <a href="{{route('instrutor.instrutores.edicao', ['id' => session('instrutor')->id])}}">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <div class="user-details">
                                        <br/>
                                        <br/>
                                        <span id="more-details">{{session('instrutor')->nome}}<i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            <a href="{{route('instrutor.instrutores.edicao', ['id' => session('instrutor')->id])}}"><i class="ti-user"></i>Perfil</a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="@if(isset($menu) && $menu=='dashboard') active @endif">
                                    <a href="{{route('instrutor.dashboard')}}" class="waves-effect waves-dark">
                            ...
                            {{-- Instrutores --}}
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="@if(isset($menu) && $menu=='instrutores') active @endif pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-user"></i><b>I</b></span>
                                        <span class="pcoded-mtext">Instrutores</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="{{route('instrutor.instrutores.novo')}}" class="waves-effect waves-dark">
                                        ...
                                        <li class="">
                                            <a href="{{route('instrutor.instrutores.listar')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            {{-- ALUNOS --}}
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="@if(isset($menu) && $menu=='alunos') active @endif pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="{{route('instrutor.alunos.novo')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Novo</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="{{route('instrutor.alunos.listar')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Listar</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
